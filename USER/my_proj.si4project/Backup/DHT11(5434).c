...
//	u8 retry = 0;
//	DHT11_IO_IN();  // 设置为输入模式
//    while (DHT11_DQ_IN && retry < 100) // 等待 DHT11 拉低40~80us
//	{
//		retry++;
//		delay_us(1);
//	};	 
...
//	else retry = 0;
//	
//    while (!DHT11_DQ_IN && retry < 100) // 等待 DHT11 拉高40~80us
//	{
//		retry++;
//		delay_us(1);
//	};
...
//	
// 	GPIO_InitStructure.GPIO_Pin = DHT11_PIN;				 // 配置PB4端口
// 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 // 推挽输出
// 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
// 	GPIO_Init(DHT11_IO, &GPIO_InitStructure);				 // 初始化IO口
// 	GPIO_SetBits(DHT11_IO, DHT11_PIN);						 // PB4 输出高
//			    
//	DHT11_Rst();  // 复位DHT11
//	return DHT11_Check(); // 检测DHT11的回应
//} 
